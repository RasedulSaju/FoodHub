        ...
        if($_SESSION['role']=='customer'){
			...
			<center>
				...
				<img src="../restaurants/<?php echo $row['restaurant_logo'] ?>" alt="<?php echo $row['restaurant_name'] ?>" height="100px" width="100px">
												<table style="color: #ffffff; background-color: #00000060; font-size: 20px;">
													<thead>
														<tr>
															...
															<th>Contact</th> <td> : </td> <td> <?php echo $row['restaurant_contact'] ?></td>
														</tr>
													</thead>
													<tbody>
                                                    <tr>
			...
			<br/>
			<table style="width:100%; color: #ffffff; background-color: #00000060; font-size: 20px;">
                    <thead>
                        <tr>
                            <th>Name</th>
                            <th>Price</th>
