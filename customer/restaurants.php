...
<?php
                    ...
                    ?>
                                ...
                                <tr>
									<td><a href="restaurant?id=<?php echo $row['restaurant_id'] ?>"><img src="../restaurants/<?php echo $row['restaurant_logo'] ?>" alt="<?php echo $row['restaurant_name'] ?>" height="80px" width="80px"></a></td>
