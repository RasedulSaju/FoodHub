...
session_start();
    if(isset($_SESSION['username']) && isset($_SESSION['role']) && isset($_SESSION['user_id']) && !empty($_SESSION['username']) && !empty($_SESSION['role']) && !empty($_SESSION['user_id'])){
        if($_SESSION['role']=='customer'){
            ...
            <body>
                <h3>Search Restaurant Including <q><b><?php echo $_GET['param1'] ?></b></q></h3>
                <ul>
                                    ...
                                    try{
                                        ...
                                        try{
                                            ...
                                            foreach($productstable as $row){
                                                ?>
                                                    <tr>
														<td><a href="restaurant?id=<?php echo $row['restaurant_id'] ?>"><img src="../restaurants/<?php echo $row['restaurant_logo'] ?>" alt="<?php echo $row['restaurant_name'] ?>" height="50px" width="50px"></a></td>
