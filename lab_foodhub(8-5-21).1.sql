...
CREATE TABLE `restaurants` (
  ...
  `restaurant_logo` varchar(15) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT 'default.jpg',
...
INSERT INTO `restaurants` (`restaurant_id`, `restaurant_name`, `restaurant_rating`, `restaurant_address`, `restaurant_logo`, `restaurant_contact`) VALUES
(1, 'EpicFC', 5, 'Jira', 'epicfc.jpg', NULL),
(2, 'SAD Food Court', 1.5, 'White House, Vatara', 'sadfc.jpg', NULL),
(3, 'KFC', 4.5, 'Chefs Table', 'kfc.png', NULL),
(4, 'Pizza Hut', 4.8, 'Wari', 'pizzahut.png', NULL);
...
(2, 'user', 'a@a.co', '+88017533', '1234', 'customer', 'Khilgaon'),
